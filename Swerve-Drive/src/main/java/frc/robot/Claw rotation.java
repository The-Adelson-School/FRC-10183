...
public class ClawRobot extends TimedRobot {
    ...
    private ClawState currentClawState = ClawState.PHASE_1; 

    private final double PHASE_1_POSITION_MOTOR_ROTATIONS = 20.0 * 3.0; 
    private final double PHASE_2_POSITION_MOTOR_ROTATIONS = 200.0 * 3.0; 
    ...
    public void robotInit() {
        clawMotor = new CANSparkMax(2, MotorType.kBrushless); // replace 2 with can id
        controller = new XboxController(0); // replace 0 with controller port
        timer = new Timer();
    }
